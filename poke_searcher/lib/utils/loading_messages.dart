  ...
  static Map<String, String> _getMessagesForLanguage(String langCode) {
    ...
    final allMessages = {
      'es': {
        ...
        'downloading_backup': 'Descargando base de datos...',
        'extracting_backup': 'Extrayendo base de datos...',
        'using_existing_data': 'Usando datos existentes...',
        'retrying_download': 'Reintentando descarga (intento {attempt}/{max})...',
        'loading_app': 'Cargando aplicación...',
        'load_complete': '¡Carga completada!',
      ...
      'en': {
        ...
        'retrying_download': 'Retrying download (attempt {attempt}/{max})...',
      ...
      'fr': {
        ...
        'using_existing_data': 'Utilisation des données existantes...',
        'retrying_download': 'Nouvelle tentative de téléchargement (tentative {attempt}/{max})...',
        'loading_app': 'Chargement de l\'application...',
        'load_complete': 'Chargement terminé!',
      ...
      'de': {
        ...
        'using_existing_data': 'Verwenden vorhandener Daten...',
        'retrying_download': 'Download wird wiederholt (Versuch {attempt}/{max})...',
        'loading_app': 'Anwendung wird geladen...',
        'load_complete': 'Laden abgeschlossen!',
      ...
      'it': {
        ...
        'downloading_backup': 'Download del backup...',
        'extracting_backup': 'Estrazione del backup...',
        'using_existing_data': 'Utilizzo dati esistenti...',
        'retrying_download': 'Riprovando download (tentativo {attempt}/{max})...',
        'loading_app': 'Caricamento dell\'applicazione...',
        'load_complete': 'Caricamento completato!',
      ...
      'pt': {
        ...
        'downloading_backup': 'Baixando backup...',
        'extracting_backup': 'Extraindo backup...',
        'using_existing_data': 'Usando dados existentes...',
        'retrying_download': 'Tentando novamente download (tentativa {attempt}/{max})...',
        'loading_app': 'Carregando aplicativo...',
        'load_complete': 'Carregamento concluído!',
